            ...
            <div class="overflow-x-auto">
                ...
                <asp:GridView ID="gvProductos" runat="server" 
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="Categoria.Descripcion" HeaderText="Categoría" HeaderStyle-CssClass="px-6 py-3" ItemStyle-CssClass="px-6 py-4" />
                            ...
                            <ItemTemplate>
                                <div class="flex justify-center gap-2">
                                    ...
                                    <asp:LinkButton ID="btnEliminar" runat="server" 
                                        CommandName="EliminarProducto" CommandArgument='<%# Eval("IdProducto") %>'
