    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div class="flex flex-wrap justify-between items-center gap-4 mb-8">
            <div class="flex flex-col gap-1">
                ...
                <p class="text-slate-500 dark:text-slate-400 text-base font-normal leading-normal">Busca y administra las categorías de tus productos.</p>
            </div>
            <div class="flex items-center gap-4 w-fit">
                <asp:HyperLink ID="btnNuevaCategoria" runat="server" NavigateUrl="~/CategoriasForm.aspx"
                    CssClass="flex cursor-pointer items-center justify-center overflow-hidden rounded-lg h-10 px-4 bg-primary text-white text-sm font-bold leading-normal tracking-[0.015em] hover:bg-primary/90 gap-2 w-fit">
        ...
        <div class="flex justify-between items-center gap-4 mb-4">
            <div class="relative w-full sm:max-w-xs">
                ...
                <asp:TextBox ID="txtBuscar" runat="server"
                    ...
                    placeholder="Buscar categoría..."></asp:TextBox>
            </div>
        </div>
