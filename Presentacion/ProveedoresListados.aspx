<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ProveedoresListados.aspx.cs" Inherits="Presentacion.ProveedoresListados" %>
                            ...
                            <ItemTemplate>
                                <div class="flex justify-center gap-2">
                                    ...
                                    <asp:HyperLink ID="btnEditar" runat="server" 
                                        NavigateUrl='<%# Eval("IDProveedor", "ProveedoresForm.aspx?id={0}") %>'
