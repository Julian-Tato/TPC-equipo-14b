<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CategoriasForm.aspx.cs" Inherits="Presentacion.CategoriasForm" %>
    ...
    <div class="max-w-2xl mx-auto">
        ...
        <div class="flex flex-wrap justify-between items-center gap-4 mb-8">
            <div class="flex flex-col gap-1">
                <h1 class="text-slate-900 dark:text-white text-3xl font-black leading-tight tracking-[-0.033em]">Detalle de Categoría</h1>
            ...
            <div class="flex flex-col gap-5">
                ...
                <label class="flex flex-col flex-1">
                    ...
                    <asp:TextBox ID="txtDescripcion" runat="server" 
                        ...
                        placeholder="Ej: Gaseosas, Lácteos, Electrónica"></asp:TextBox>
                </label>
